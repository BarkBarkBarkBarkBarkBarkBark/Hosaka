...
COMMANDS: list[tuple[str, str, str]] = [
    ...
    ("/netscan",        "Scan local network for devices (arp-scan/nmap)","Network"),
    ...
    # ── Todo ──
    ("/todo",           "Show todo list",                                "Todo"),
    ("/todo add <item>","Add a todo item",                               "Todo"),
    ("/todo list",      "List all todo items",                           "Todo"),
    ("/todo done <n>",  "Mark item N as done",                           "Todo"),
    ("/todo remove <n>","Remove item N",                                 "Todo"),
    ("/todo clear",     "Clear all completed items",                     "Todo"),
    # ── Video ──
    ("/video <url>",    "Send a video URL to the kiosk video panel",     "Video"),
    # ── Tools ──
